...
import { emptyCart } from "../slices/cartSlice.jsx";
  ...
  return (
    <View className="flex-1">
      ...
      <View className="rounded-t-3xl -mt-12 bg-white relative">
        ...
        >
          <View
            className="roundedfull p-1"
            style={{ backgroundColor: "rgba(255,255,255,0.4" }}
          >
            <Image
              className="w-16 h-16 rounded-full"
              source={require("../../assets/images/deliveryGirl.jpg")}
            />
          </View>
          <View className="flex-1 ml-3">
            <Text className="text-lg font-bold text-white">Sarah Connor</Text>
